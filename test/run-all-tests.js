...
if (grandFailed === 0) {
  ...
  if (jsonToTsResults.failed > 0) {
    console.log('\nJSON to TypeScript failures:');
    jsonToTsResults.failedTests.forEach(test => console.log(`   - ${test}`));
  }
