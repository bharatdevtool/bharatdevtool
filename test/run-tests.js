...
/**
 * Command Line Test Runner for Bharat Dev Tools JSON Formatter
 * 
 * This script runs comprehensive tests for all functionality built in this project:
 * - Basic JSON formatting and minification
 * - JSON validation and error handling
 * - JSON escape/unescape functionality
 * - JSON repair (trailing commas, unquoted keys, comments, etc.)
...
const formatterPath = join(__dirname, '../assets/js/formatter.js');
const formatterCode = readFileSync(formatterPath, 'utf8');

// Create a mock environment for the formatter
const mockConsole = {
  log: () => {},
  warn: () => {},
  error: () => {}
...
// Evaluate the formatter code in a controlled environment
const formatterModule = new Function('console', formatterCode)(mockConsole);
...
console.log('🧪 Bharat Dev Tools - Test Suite');
console.log('================================\n');
