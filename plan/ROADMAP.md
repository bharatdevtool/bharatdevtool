...
| 2 | WhatsApp Link Generator | utility | High (India) | 0.5d | `in-progress` | `whatsapp-link.html` |
...
| 5 | Password Generator | security | High | 0.5d | `not-started` | `password-generator.html` |
